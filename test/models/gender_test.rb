...
class GenderTest < ActiveSupport::TestCase
  ...
  test "should create a valid gender" do
    gender = Gender.new(name: "name_1", sptf_gender_id: "spotify_12345", user: @existing_user)
    assert gender.save, "Failed to save a valid gender"
  end

  test "should not save gender without name, sptf_gender_id or user_id" do
    gender = Gender.new(sptf_gender_id: "spotify_12345", user: @existing_user)
    assert_not gender.save, "Saved the gender without a name"
    gender = Gender.new(name: "name_1", user: @existing_user)
    assert_not gender.save, "Saved the gender without a sptf_gender_id"
    gender = Gender.new(name: "name_1", sptf_gender_id: "spotify_12345")
    assert_not gender.save, "Saved the gender without a user_id"
  end

  test "should allow setting deleted_at" do
    gender = Gender.create(name: "name_1", sptf_gender_id: "spotify_12345", user: @existing_user)
